        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div class="text-center md:text-left">
                ...
                <p class="mt-4 text-gray-600 text-lg">
                    Tenemos el orgullo de poder decir que nuestra materia prima principal, la leche, es de nuestra
                    elaboración. Nadie mejor que nosotros para saber cómo crecen nuestras mejores socias.
                </p>
                <div class="mt-8">
                    <x-mary-button label="Descubrir más de 100%NAT"
            ...
            <div class="w-full flex flex-col items-center lg:items-end text-center lg:text-right">
                <img src="{{ asset('images/LOS_NENITOS.webp') }}" alt="Los Nenitos Logo"
                    class="w-1/3 h-auto mx-auto lg:mx-0 mb-4">
                <div class="mt-8">
                    <a href="https://polijubweb.test/los-nenitos"
