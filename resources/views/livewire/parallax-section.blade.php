<div id="{{ $id }}" class="relative min-h-[70vh] bg-no-repeat bg-cover bg-center bg-fixed {{ $classes }}"
    style="background-image: url('{{ asset($bg_image) }}');">
    
    <!-- Top Decorative Image: Milk Down -->
    @if($top_image)
        <img src="{{ asset($top_image) }}" alt="Top Decorative" class="absolute top-0 left-0 w-full z-0">
    @endif
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 flex flex-col items-center justify-center text-center">
        ...
        <div class="text-left text-white mb-16 mt-32">
            ...
            <p class="mt-6 max-w-3xl text-lg md:text-xl">
                En el centro de Reconquista, Av. Habegger y Obligado tenemos la central de pedidos...
            </p>
        ...
        <div class="relative bg-white rounded-[2rem] shadow-2xl p-8 md:p-12 -mt-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 text-center">
                <!-- Pasos con rutas corregidas (Mayúsculas/Minúsculas) -->
                <div class="flex flex-col items-center">
                    <span class="text-6xl font-extrabold text-gray-700 leading-none">01</span>
                    <img src="{{ asset('images/lupa.avif') }}" class="w-32 h-32 object-contain" alt="Lupa">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <img src="{{ asset('images/PAGAR.avif') }}" class="w-32 h-32 object-contain" alt="Pagar">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <img src="{{ asset('images/CORAZON.avif') }}" class="w-32 h-32 object-contain" alt="Corazón">
