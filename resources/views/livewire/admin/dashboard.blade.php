<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        <x-stat title="Ventas Totales" value="${{ number_format($totalRevenue, 2) }}" icon="o-currency-dollar" class="text-emerald-500 bg-emerald-50" />
        <x-stat title="Pedidos Pendientes" value="{{ $pendingOrders }}" icon="o-shopping-bag" class="text-orange-500 bg-orange-50" />
        <x-stat title="Usuarios" value="{{ $usersCount }}" icon="o-users" class="text-blue-500 bg-blue-50" />
        <x-stat title="Productos Activos" value="{{ $productsCount }}" icon="o-cube" class="text-purple-500 bg-purple-50" />
    </div>
        ...
        <div class="space-y-6">
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <x-button icon="o-cube" label="Nuevo Producto" link="{{ route('admin.products', ['create' => true]) }}" class="btn-outline" />
                        <x-button icon="o-beaker" label="Nuevo Sabor" link="{{ route('admin.flavors', ['create' => true]) }}" class="btn-outline" />
                        <x-button icon="o-tag" label="Nueva Etiqueta" link="{{ route('admin.tags', ['create' => true]) }}" class="btn-outline" />
            ...
            <div class="card bg-primary text-primary-content shadow-xl">
                <div class="card-body">
                    ...
                    <p>Bienvenido al panel de administración. Revisa las estadísticas y gestiona tu catálogo fácilmente.</p>
