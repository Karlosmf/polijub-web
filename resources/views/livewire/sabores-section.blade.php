<div>
    <section id="sabores" class="relative min-h-[80vh] flex items-center"
        style="background-image: url('{{ asset('images/helados.webp') }}'); background-size: cover; background-position: center;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
                    <div class="text-left">
                        ...
                        <p class="mt-4 font-light text-gray-700 leading-relaxed">
                            Siempre es un buen momento para descubrir nuestros nuevos sabores, porque al igual que
                            siempre, probamos cosas ricas que nos gustan a todos, y las convertimos en helado de la
                            mejor calidad... Calidad Polijub.
                        </p>
                    </div>
        ...
        {{-- Imagen Superpuesta --}}
        <img src="{{ asset('images/milkup.webp') }}" alt="Milk Up"
