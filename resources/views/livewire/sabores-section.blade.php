<div>
    <section id="sabores" class="relative min-h-[80vh] flex items-center" style="background-image: url('{{ asset('images/helados.webp') }}'); background-size: cover; background-position: center;">
        ...
        {{-- Imagen Superpuesta --}}
        <img src="{{ asset('images/milkup.webp') }}" alt="Milk Up" class="absolute bottom-0 left-1/2 -translate-x-1/2 w-full z-0">
